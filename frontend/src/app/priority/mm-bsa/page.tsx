...
// 1. Define the shape of your data so TypeScript stops complaining
...
export default function MMBSAHome() {
  ...
  // 2. Tell TypeScript this state can be either the data object OR null
  const [roscoStatus, setRoscoStatus] = useState<RoscoStatusData | null>(null)

  // 3. Type the event as a FormEvent
  ...
  // Helper function for unimplemented checks
