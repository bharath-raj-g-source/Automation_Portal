...
export default function Page() {
  ...
  const runChecks = async () => {
    ...
    try {
      ...
      console.error(e);
      alert("Failed to run MM QC Check");
    }
  };
    ...
    <div className="flex flex-col gap-6 p-6 w-full">
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="rounded-2xl p-5 bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-700">
            <h3 className="text-sm font-semibold mb-4 text-slate-700 dark:text-slate-200 flex items-center gap-2">
            ...
            <div className="flex flex-col gap-3">
              <input
                ...
                className="w-full rounded-lg px-3 py-2 text-sm bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-800 dark:text-white"
              />
              <input
                type="text"
                value={deliveryId}
          ...
          <div className="rounded-2xl p-5 bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-700">
            ...
            <div className="flex gap-3 mb-4">
              <input
                ...
                value={startDate}
                onChange={(e) => setStartDate(e.target.value)}
                className="w-full rounded-lg px-3 py-2 text-sm bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-800 dark:text-white dark:scheme-dark"
              />
              <input
                type="date"
                value={endDate}
          ...
          <div className="rounded-2xl p-6 flex flex-col items-center justify-center gap-4 bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-700">
            <button
              onClick={runChecks}
              disabled={!ready || loading}
              className="w-full py-3 rounded-xl font-semibold text-white bg-blue-600 hover:bg-blue-500 flex items-center justify-center gap-2"
            >
              {loading ? <Loader className="animate-spin" size={16} /> : <UploadCloud size={16} />}
              {loading ? "Running..." : "Run Checks"}
            </button>
